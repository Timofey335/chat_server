...
test:
	go clean -testcache
	go test ./... -coverprofile=coverage.tmp.out -covermode count -coverpkg=github.com/Timofey335/chat-server/internal/service/...,github.com/Timofey335/chat-server/internal/api/... -count 5
